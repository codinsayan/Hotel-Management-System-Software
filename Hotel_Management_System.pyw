...
class Register:
    def __init__(self,root):
        ...
        registerbtnimg=registerbtnimg.resize((300,50),Image.Resampling.LANCZOS)
        ...
        pathget("login.png")
        loginbtnimg=image         
        loginbtnimg=loginbtnimg.resize((100,30),Image.Resampling.LANCZOS)
...
class HotelmanagementSystem:
    def __init__(self,root):
        ...
        #==========================================title=============================================
        lbl_title=Label(self.root,text="PREMIUM HOTEL", font=("times new roman",40,"bold"),bg="black",fg="gold",bd=2,relief=RIDGE)
